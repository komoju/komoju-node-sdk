 ...
 * 
 * @export
 * @interface ResponsePaymentDetailsBitCash
 */
export interface ResponsePaymentDetailsBitCash {
    /**
     * Payment method type.
     * @type {string}
     * @memberof ResponsePaymentDetailsBitCash
     */
    'type': ResponsePaymentDetailsBitCashTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum ResponsePaymentDetailsBitCashTypeEnum {
    BitCash = 'bit_cash'
}
