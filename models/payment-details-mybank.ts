 ...
 * 
 * @export
 * @interface PaymentDetailsMybank
 */
export interface PaymentDetailsMybank {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsMybank
     */
    'type': PaymentDetailsMybankTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsMybankTypeEnum {
    Mybank = 'mybank'
}
