 ...
 * 
 * @export
 * @interface PaymentDetailsSepaTransfer
 */
export interface PaymentDetailsSepaTransfer {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsSepaTransfer
     */
    'type': PaymentDetailsSepaTransferTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsSepaTransferTypeEnum {
