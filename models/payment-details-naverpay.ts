 ...
 * 
 * @export
 * @interface PaymentDetailsNaverpay
 */
export interface PaymentDetailsNaverpay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsNaverpay
     */
    'type': PaymentDetailsNaverpayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsNaverpayTypeEnum {
    Naverpay = 'naverpay'
}
