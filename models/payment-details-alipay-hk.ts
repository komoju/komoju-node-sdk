 ...
 * 
 * @export
 * @interface PaymentDetailsAlipayHK
 */
export interface PaymentDetailsAlipayHK {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsAlipayHK
     */
    'type': PaymentDetailsAlipayHKTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsAlipayHKTypeEnum {
    AlipayHk = 'alipay_hk'
}
