 ...
 * 
 * @export
 * @interface PaymentDetailsTNG
 */
export interface PaymentDetailsTNG {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsTNG
     */
    'type': PaymentDetailsTNGTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsTNGTypeEnum {
    Tng = 'tng'
}
