 ...
 * 
 * @export
 * @interface PaymentDetailsEps
 */
export interface PaymentDetailsEps {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsEps
     */
    'type': PaymentDetailsEpsTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsEpsTypeEnum {
    Eps = 'eps'
}
