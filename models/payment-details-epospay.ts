 ...
 * 
 * @export
 * @interface PaymentDetailsEpospay
 */
export interface PaymentDetailsEpospay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsEpospay
     */
    'type': PaymentDetailsEpospayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsEpospayTypeEnum {
    Epospay = 'epospay'
}
