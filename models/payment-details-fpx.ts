 ...
 * 
 * @export
 * @interface PaymentDetailsFpx
 */
export interface PaymentDetailsFpx {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsFpx
     */
    'type': PaymentDetailsFpxTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsFpxTypeEnum {
    Fpx = 'fpx'
}
