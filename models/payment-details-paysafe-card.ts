 ...
 * 
 * @export
 * @interface PaymentDetailsPaysafeCard
 */
export interface PaymentDetailsPaysafeCard {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPaysafeCard
     */
    'type': PaymentDetailsPaysafeCardTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPaysafeCardTypeEnum {
