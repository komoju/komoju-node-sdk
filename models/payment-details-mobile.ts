 ...
 * 
 * @export
 * @interface PaymentDetailsMobile
 */
export interface PaymentDetailsMobile {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsMobile
     */
    'type': PaymentDetailsMobileTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsMobileTypeEnum {
    Mobile = 'mobile'
}
