 ...
 * 
 * @export
 * @interface PaymentDetailsGiropay
 */
export interface PaymentDetailsGiropay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsGiropay
     */
    'type': PaymentDetailsGiropayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsGiropayTypeEnum {
    Giropay = 'giropay'
}
