 ...
 * 
 * @export
 * @interface PaymentDetailsSoftbank
 */
export interface PaymentDetailsSoftbank {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsSoftbank
     */
    'type': PaymentDetailsSoftbankTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsSoftbankTypeEnum {
    Softbank = 'softbank'
}
