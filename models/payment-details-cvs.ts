 ...
 * 
 * @export
 * @interface PaymentDetailsCVS
 */
export interface PaymentDetailsCVS {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsCVS
     */
    'type': PaymentDetailsCVSTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsCVSTypeEnum {
    Cvs = 'cvs'
}
