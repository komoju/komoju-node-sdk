 ...
 * 
 * @export
 * @interface PaymentDetailsRakutenpay
 */
export interface PaymentDetailsRakutenpay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsRakutenpay
     */
    'type': PaymentDetailsRakutenpayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsRakutenpayTypeEnum {
