 ...
 * 
 * @export
 * @interface PaymentDetailsGCash
 */
export interface PaymentDetailsGCash {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsGCash
     */
    'type': PaymentDetailsGCashTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsGCashTypeEnum {
    Gcash = 'gcash'
}
