 ...
 * 
 * @export
 * @interface PaymentDetailsPayPay
 */
export interface PaymentDetailsPayPay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPayPay
     */
    'type': PaymentDetailsPayPayTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof PaymentDetailsPayPay
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPayPayTypeEnum {
    Paypay = 'paypay'
}
