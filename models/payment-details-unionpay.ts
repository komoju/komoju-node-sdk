 ...
 * 
 * @export
 * @interface PaymentDetailsUnionpay
 */
export interface PaymentDetailsUnionpay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsUnionpay
     */
    'type': PaymentDetailsUnionpayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsUnionpayTypeEnum {
    Unionpay = 'unionpay'
}
