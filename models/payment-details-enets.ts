 ...
 * 
 * @export
 * @interface PaymentDetailsEnets
 */
export interface PaymentDetailsEnets {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsEnets
     */
    'type': PaymentDetailsEnetsTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsEnetsTypeEnum {
    Enets = 'enets'
}
