 ...
 * 
 * @export
 * @interface PaymentDetailsMerpay
 */
export interface PaymentDetailsMerpay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsMerpay
     */
    'type': PaymentDetailsMerpayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsMerpayTypeEnum {
    Merpay = 'merpay'
}
