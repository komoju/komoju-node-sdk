 ...
 * 
 * @export
 * @interface PaymentDetailsPaysera
 */
export interface PaymentDetailsPaysera {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPaysera
     */
    'type': PaymentDetailsPayseraTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPayseraTypeEnum {
    Paysera = 'paysera'
}
