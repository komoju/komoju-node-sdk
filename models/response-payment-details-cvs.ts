 ...
 * 
 * @export
 * @interface ResponsePaymentDetailsCVS
 */
export interface ResponsePaymentDetailsCVS {
    /**
     * Payment method type.
     * @type {string}
     * @memberof ResponsePaymentDetailsCVS
     */
    'type': ResponsePaymentDetailsCVSTypeEnum;
    /**
    ...
    'email': string;
    /**
     * Barcode number for the CVS payment slip.
     * @type {string}
     * @memberof ResponsePaymentDetailsCVS
     */
    'bardcode'?: string;
...
/**
    ...
    * @enum {string}
    */
export enum ResponsePaymentDetailsCVSTypeEnum {
    Cvs = 'cvs'
}
