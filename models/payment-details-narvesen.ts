 ...
 * 
 * @export
 * @interface PaymentDetailsNarvesen
 */
export interface PaymentDetailsNarvesen {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsNarvesen
     */
    'type': PaymentDetailsNarvesenTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsNarvesenTypeEnum {
    Narvesen = 'narvesen'
}
