 ...
 * 
 * @export
 * @interface PaymentDetailsOvo
 */
export interface PaymentDetailsOvo {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsOvo
     */
    'type': PaymentDetailsOvoTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsOvoTypeEnum {
    Ovo = 'ovo'
}
