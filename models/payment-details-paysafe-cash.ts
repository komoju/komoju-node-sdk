 ...
 * 
 * @export
 * @interface PaymentDetailsPaysafeCash
 */
export interface PaymentDetailsPaysafeCash {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPaysafeCash
     */
    'type': PaymentDetailsPaysafeCashTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPaysafeCashTypeEnum {
