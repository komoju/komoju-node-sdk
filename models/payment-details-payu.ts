 ...
 * 
 * @export
 * @interface PaymentDetailsPayu
 */
export interface PaymentDetailsPayu {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPayu
     */
    'type': PaymentDetailsPayuTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPayuTypeEnum {
    Payu = 'payu'
}
