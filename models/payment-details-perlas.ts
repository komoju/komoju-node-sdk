 ...
 * 
 * @export
 * @interface PaymentDetailsPerlas
 */
export interface PaymentDetailsPerlas {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPerlas
     */
    'type': PaymentDetailsPerlasTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPerlasTypeEnum {
    Perlas = 'perlas'
}
