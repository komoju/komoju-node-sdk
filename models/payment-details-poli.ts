 ...
 * 
 * @export
 * @interface PaymentDetailsPoli
 */
export interface PaymentDetailsPoli {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPoli
     */
    'type': PaymentDetailsPoliTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPoliTypeEnum {
    Poli = 'poli'
}
