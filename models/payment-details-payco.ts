 ...
 * 
 * @export
 * @interface PaymentDetailsPayco
 */
export interface PaymentDetailsPayco {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsPayco
     */
    'type': PaymentDetailsPaycoTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsPaycoTypeEnum {
    Payco = 'payco'
}
