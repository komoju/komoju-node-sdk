 ...
 * 
 * @export
 * @interface PaymentDetailsDana
 */
export interface PaymentDetailsDana {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsDana
     */
    'type': PaymentDetailsDanaTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsDanaTypeEnum {
    Dana = 'dana'
}
