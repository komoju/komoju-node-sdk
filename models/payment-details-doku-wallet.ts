 ...
 * 
 * @export
 * @interface PaymentDetailsDokuWallet
 */
export interface PaymentDetailsDokuWallet {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsDokuWallet
     */
    'type': PaymentDetailsDokuWalletTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsDokuWalletTypeEnum {
