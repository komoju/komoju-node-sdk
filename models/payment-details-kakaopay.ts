 ...
 * 
 * @export
 * @interface PaymentDetailsKakaopay
 */
export interface PaymentDetailsKakaopay {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsKakaopay
     */
    'type': PaymentDetailsKakaopayTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsKakaopayTypeEnum {
    Kakaopay = 'kakaopay'
}
