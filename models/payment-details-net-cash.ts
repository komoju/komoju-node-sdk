 ...
 * 
 * @export
 * @interface PaymentDetailsNetCash
 */
export interface PaymentDetailsNetCash {
    /**
     ...
     * @type {string}
     * @memberof PaymentDetailsNetCash
     */
    'type': PaymentDetailsNetCashTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsNetCashTypeEnum {
    NetCash = 'net_cash'
}
