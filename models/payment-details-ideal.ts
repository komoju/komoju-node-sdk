 ...
 * 
 * @export
 * @interface PaymentDetailsIdeal
 */
export interface PaymentDetailsIdeal {
    /**
     * Payment method type.
     * @type {string}
     * @memberof PaymentDetailsIdeal
     */
    'type': PaymentDetailsIdealTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum PaymentDetailsIdealTypeEnum {
    Ideal = 'ideal'
}
