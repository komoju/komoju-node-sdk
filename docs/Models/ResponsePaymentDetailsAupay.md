...
| **transaction\_id** | **String** | Transaction identifier returned by au PAY. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the au PAY payment. | [optional] [default to null] |
