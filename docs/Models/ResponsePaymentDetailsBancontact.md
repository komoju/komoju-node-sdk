...
| **transaction\_key** | **String** | Transaction key returned by Bancontact. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Bancontact payment. | [optional] [default to null] |
