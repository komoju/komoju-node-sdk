...
| **transaction\_id** | **String** | Transaction identifier returned by Alipay. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Alipay payment. | [optional] [default to null] |
