...
|------------ | ------------- | ------------- | -------------|
| **type** | **String** | Payment method type.  **Note:** Unlike other prepaid payment methods, this payment method does **NOT** support updating the payment with additional prepaid cards. | [default to null] |
