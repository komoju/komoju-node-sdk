...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the BLIK payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by BLIK. | [optional] [default to null] |
