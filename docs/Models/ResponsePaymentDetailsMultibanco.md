...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Multibanco payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Multibanco. | [optional] [default to null] |
