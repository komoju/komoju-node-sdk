...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Paysera payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Paysera. | [optional] [default to null] |
