...
| **transaction\_key** | **String** | Transaction key returned by giropay. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the giropay payment. | [optional] [default to null] |
