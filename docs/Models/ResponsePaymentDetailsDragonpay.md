...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Dragonpay payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Dragonpay. | [optional] [default to null] |
