...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the FPX payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by FPX. | [optional] [default to null] |
