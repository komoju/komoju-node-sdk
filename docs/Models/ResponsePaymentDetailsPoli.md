...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the POLi payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by POLi. | [optional] [default to null] |
