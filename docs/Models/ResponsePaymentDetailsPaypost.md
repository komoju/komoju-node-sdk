...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the PayPost payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by PayPost. | [optional] [default to null] |
