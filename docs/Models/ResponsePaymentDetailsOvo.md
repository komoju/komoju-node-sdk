...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the OVO payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by OVO. | [optional] [default to null] |
