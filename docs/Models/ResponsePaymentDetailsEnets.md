...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the eNETS payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by eNETS. | [optional] [default to null] |
