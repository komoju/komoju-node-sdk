...
|------------ | ------------- | ------------- | -------------|
| **resource** | **String** | Resource type name, always \&quot;list\&quot;. | [default to null] |
| **data** | [**List**](ChargebackRequestListItem.md) | Array of chargeback request objects for this page. | [default to null] |
...
| **per\_page** | **Integer** | Number of results per page. | [default to null] |
| **last\_page** | **Integer** | Last available page number. | [default to null] |
