...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Przelewy24 payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Przelewy24. | [optional] [default to null] |
