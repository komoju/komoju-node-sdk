...
| **provider** | **String** | Mobile carrier or payment provider for this payment. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the mobile payment. | [optional] [default to null] |
