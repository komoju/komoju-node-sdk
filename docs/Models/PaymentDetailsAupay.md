...
| **scanned\_code** | **String** | For physical store payment scenario, specify customer&#39;s payment code that you&#39;ve scanned.  When omitted, customer will have to visit a given URL the response to complete the payment. | [optional] [default to null] |
