...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the au payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by au. | [optional] [default to null] |
