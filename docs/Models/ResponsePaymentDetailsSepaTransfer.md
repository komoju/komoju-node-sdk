...
| **transaction\_key** | **String** | Transaction key returned by the SEPA transfer provider. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the SEPA transfer. | [optional] [default to null] |
