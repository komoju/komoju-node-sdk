...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Narvesen payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Narvesen. | [optional] [default to null] |
