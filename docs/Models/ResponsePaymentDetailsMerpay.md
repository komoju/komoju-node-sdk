...
| **transaction\_key** | **String** | Transaction key returned by Merpay. | [optional] [default to null] |
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Merpay payment. | [optional] [default to null] |
