...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the PayU payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by PayU. | [optional] [default to null] |
