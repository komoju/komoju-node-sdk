...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the PIX payment. | [optional] [default to null] |
| **transaction\_code** | **String** | PIX transaction code. | [optional] [default to null] |
| **qr\_code\_url** | **String** | URL to the QR code image for the PIX payment. | [optional] [default to null] |
