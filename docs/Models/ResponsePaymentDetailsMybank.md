...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the MyBank payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by MyBank. | [optional] [default to null] |
