...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the DOKU Wallet payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by DOKU. | [optional] [default to null] |
