...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the Perlas payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by Perlas. | [optional] [default to null] |
