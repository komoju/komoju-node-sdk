...
| **family\_name** | **String** | Family name of the customer. It will appear on the Konbini payment receipt. | [optional] [default to null] |
| **given\_name** | **String** | Given name of the customer. It will appear on the Konbini payment receipt. | [optional] [default to null] |
