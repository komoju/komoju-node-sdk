...
| **redirect\_url** | **String** | URL to redirect the customer to for completing the eps payment. | [optional] [default to null] |
| **transaction\_id** | **String** | Transaction identifier returned by eps. | [optional] [default to null] |
